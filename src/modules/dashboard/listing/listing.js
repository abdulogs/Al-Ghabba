                ...
                if (data.count != 0) {
                    ...
                    data.results.forEach(item => {
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-break" data-label="Image">${image(item.image)}</td>
                            <td class="align-middle text-break" data-label="Name">${title(item.name)}</td>
                            <td class="align-middle text-break" data-label="Beds">${item.bedroom}</td>
                            <td class="align-middle text-break" data-label="Baths">${item.bathroom}</td>
                            <td class="align-middle text-break" data-label="Price">${item.price}</td>
